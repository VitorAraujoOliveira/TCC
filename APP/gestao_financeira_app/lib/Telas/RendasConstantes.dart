...
class RendasConstantes extends StatefulWidget {
  @override
  RendasConstantesTela createState() => RendasConstantesTela();
}

class RendasConstantesTela extends State<RendasConstantes> {
  var tipoFixa = false;
